      ...
      /*  public static Model.RespostaErro Encomendas_New(Model.DocVenda dv)
        ...
        public static List<Model.DocVenda> Encomendas_List(string typeDoc, string dateBegin, string dateEnd)
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                while (!objListCab.NoFim())
                {
                    ...
                    objListLin = PriEngine.Engine.Consulta("SELECT idCabecDoc, Artigo, Descricao, TaxaIva ,Quantidade, Unidade, PrecUnit, Desconto1, TotalIva, PrecoLiquido from LinhasDoc where IdCabecDoc='" + dv.id + "' order By NumLinha");
                    ...
                    while (!objListLin.NoFim())
                    {
                        ...
                        lindv.TotalILiquido = objListLin.Valor("TotalIva") + objListLin.Valor("PrecoLiquido");
        ...
        public static List<Model.Dashboard> GetDashboard()
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                oc.AccountsReceivable = objList.Valor("accountsreceivable") + objList.Valor("var3"); ;
                oc.AccountsPayable = objList.Valor("accountspayable") + objList.Valor("var2"); ;
